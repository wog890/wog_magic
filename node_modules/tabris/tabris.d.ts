...
export class Page extends Composite {
   ...
   * An image to be displayed in the navigation bar.
   */
  set(property: "icon", value: Image): this;
...
export class Video extends Widget {
  ...
  /**
   * Starts playing the video, *[state](#state)* changes to `play`. Has no effect if the current state is
   * not either `pause` or `ready`.
   */
  play(): void;
  ...
  off(event: "animationend", listener?: Function, context?: this): this;
  off(event: "animationstart", listener?: Function, context?: this): this;
  off(event: "change:state", listener?: Function, context?: this): this;
  off(event: "change:{property}", listener?: Function, context?: this): this;
  off(event: "dispose", listener?: Function, context?: this): this;
  off(event: "longpress", listener?: Function, context?: this): this;
  off(event: "pan", listener?: Function, context?: this): this;
  ...
  on(event: "animationend", listener: (widget: this, options: Object) => any): this;
  on(event: "animationstart", listener: (widget: this, options: Object) => any): this;
  on(event: "change:state", listener: (widget: this, state: string, options: Object) => any): this;
  on(event: "change:{property}", listener: (widget: this, value: any, options: Object) => any): this;
  on(event: "dispose", listener: (widget: this) => any): this;
  on(event: "longpress", listener: (widget: this, gesture: GestureObject) => any): this;
  on(event: "pan", listener: (widget: this, gesture: GestureObject) => any): this;
  ...
  once(event: "animationend", listener: (widget: this, options: Object, context?: this) => any): this;
  once(event: "animationstart", listener: (widget: this, options: Object, context?: this) => any): this;
  once(event: "change:state", listener: (widget: this, state: string, options: Object, context?: this) => any): this;
  once(event: "change:{property}", listener: (widget: this, value: any, options: Object, context?: this) => any): this;
  once(event: "dispose", listener: (widget: this, context?: this) => any): this;
  once(event: "longpress", listener: (widget: this, gesture: GestureObject, context?: this) => any): this;
  once(event: "pan", listener: (widget: this, gesture: GestureObject, context?: this) => any): this;
   ...
   */
  get(property: "controlsVisible"): boolean;
  ...
  /**
   * Returns the current playback position in milliseconds. This property is read-only. This property does
   * not trigger any change events.
   */
  get(property: "position"): number;
   ...
   * *[state](#state)* of the widget is not `play` this property always has the value `0`. This property
   * is read-only.
   */
  get(property: "speed"): number;
   ...
   * * `ready` - The video is ready to play. If `autoPlay` is `true` the state will automatically change
   * from `ready` to `play`.
   * * `play` - The video is currently playing.
   * * `stale` - The playback was paused for buffering, but will continue once enough data has been
   * buffered.
   ...
   * *[state](#state)* to `open` and the video starts loading. Seting this property to an empty string
   ...
   * If set to `true`, starts playing the video as soon as the state changes from `open` to `ready`.
   */
  set(property: "autoPlay", value: boolean): this;
   ...
   * If set to `true`, overlays the video with a native UI for controlling playback.
   */
  set(property: "controlsVisible", value: boolean): this;
   ...
   * Returns the full length of the current video in milliseconds. This property is read-only.
   */
  set(property: "duration", value: number): this;
   ...
   * not trigger any change events.
   */
  set(property: "position", value: number): this;
   ...
   * is read-only.
   */
  set(property: "speed", value: number): this;
   ...
   */
  set(property: "state", value: string): this;
  set(property: "state", value: "empty"): this;
  set(property: "state", value: "fail"): this;
  set(property: "state", value: "finish"): this;
  set(property: "state", value: "open"): this;
  set(property: "state", value: "pause"): this;
  set(property: "state", value: "play"): this;
  set(property: "state", value: "ready"): this;
  set(property: "state", value: "stale"): this;
...
export class WebView extends Widget {
  ...
  off(event: "change:{property}", listener?: Function, context?: this): this;
  off(event: "dispose", listener?: Function, context?: this): this;
  off(event: "download", listener?: Function, context?: this): this;
  off(event: "load", listener?: Function, context?: this): this;
  off(event: "longpress", listener?: Function, context?: this): this;
  ...
  on(event: "change:{property}", listener: (widget: this, value: any, options: Object) => any): this;
  on(event: "dispose", listener: (widget: this) => any): this;
  on(event: "download", listener: (widget: this, event: Object) => any): this;
  on(event: "load", listener: (widget: this) => any): this;
  on(event: "longpress", listener: (widget: this, gesture: GestureObject) => any): this;
  on(event: "message", listener: (widget: this, event: {data: string}) => any): this;
  on(event: "navigate", listener: (widget: this, event: Object) => any): this;
  on(event: "pan", listener: (widget: this, gesture: GestureObject) => any): this;
  on(event: "pan:down", listener: (widget: this, gesture: GestureObject) => any): this;
  on(event: "pan:left", listener: (widget: this, gesture: GestureObject) => any): this;
  on(event: "pan:right", listener: (widget: this, gesture: GestureObject) => any): this;
  ...
  once(event: "change:{property}", listener: (widget: this, value: any, options: Object, context?: this) => any): this;
  once(event: "dispose", listener: (widget: this, context?: this) => any): this;
  once(event: "download", listener: (widget: this, event: Object, context?: this) => any): this;
  ...
  once(event: "navigate", listener: (widget: this, event: Object, context?: this) => any): this;
  once(event: "pan", listener: (widget: this, gesture: GestureObject, context?: this) => any): this;
  once(event: "pan:down", listener: (widget: this, gesture: GestureObject, context?: this) => any): this;
  once(event: "pan:left", listener: (widget: this, gesture: GestureObject, context?: this) => any): this;
  once(event: "pan:right", listener: (widget: this, gesture: GestureObject, context?: this) => any): this;
...
export class InactivityTimer {
  ...
  constructor(properties?: InactivityTimerProperties);
   ...
   */
  off(event?: string, listener?: Function, context?: this): this;
  off(event: "timeout", listener?: Function, context?: this): this;
   ...
   */
  on(event: string, listener: Function, context?: this): this;
  on(event: "timeout", listener: (target: this) => any): this;
   ...
   */
  once(event: string, listener: Function, context?: this): this;
  once(event: "timeout", listener: (target: this, context?: this) => any): this;
   ...
   * property will not affect a running timer.
   */
  set(property: "delay", value: number): this;
}

interface InactivityTimerProperties {
